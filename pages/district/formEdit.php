...
$qt = mysqli_query($koneksi, "SELECT * FROM district WHERE id='" . $_GET["id"] . "' ");
				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							<h3>Edit Data Kota / Kabupaten</h3>
						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Edit Data Kota / Kabupaten</li>
								</ol>
							</nav>
						</div>
					</div>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/areaController.php?action=editDataDistrict" method="POST">
											<?php $timestart = time(); ?>
