				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							<h3>View Data Kota / Kabupaten</h3>
						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">View Data Kota / Kabupaten</li>
								</ol>
							</nav>
						</div>
					</div>
									...
									<div class="card-body px-3 py-4-5">
										<div class="row">
											...
											<div class="col-md-8">
												...
												$dd = mysqli_fetch_array($qd);
												?>
												<h6 class="text-muted font-semibold">Total Kota / Kabupaten</h6>
												<h6 class="font-extrabold mb-0"><?php echo $dd["jml"] ?></h6>
											</div>
										</div>
									</div>
										...
										<form class="form form-horizontal">
											...
											<div class="form-body">
												<div class="row" style="margin-top:40px;">
													<div class="alert alert-danger">Lihat Data Kota / Kabupaten</div>
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-3">
