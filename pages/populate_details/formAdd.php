...
$qk = mysqli_query($koneksi, "SELECT * FROM district");
$qe = mysqli_query($koneksi, "SELECT * FROM sub_district");
$qde = mysqli_query($koneksi, "SELECT * FROM village");
?>
...
<body>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/kamusController.php?action=addData" method="POST" enctype="multipart/form-data">
											<?php $timestart = time(); ?>
													...
													<div class="col-md-12">
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																...
																<select name="country_location" class="col-12" style="border-color:#435ebe; color:#000000; padding: 8px 8px; border-radius: 4px;" disabled value="indonesia">
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																...
																<select name="province_location" class="col-12" style="border-color:#435ebe; color:#000000; padding: 8px 8px; border-radius: 4px;" disabled>
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<select name="district_location" class="col-12" style="border-color:#435ebe; color:#000000; padding: 8px 8px; border-radius: 4px;" onchange="
																$.ajax({
																	url: '../../apps/kamusController.php?action=getSubDistrict',
																	type: 'GET',
																	data: {
																		district_id: this.value
																	},
																	success: function(data) {
																		$('#subdistrict-list').html(data);
																	},
																});
																">
																	<?php foreach ($qk as $dk) { ?>
														...
														<div class=" row">
															...
															<div class="col-md-9 form-group">
																...
																<select name="subdistrict_location" class="col-12" style="border-color:#435ebe; color:#000000; padding: 8px 8px; border-radius: 4px;" onchange="
																$.ajax({
																	url: '../../apps/kamusController.php?action=getVillage',
																	type: 'GET',
																	data: {
																		subdistrict_id: this.value
																	},
																	success: function(data) {
																...
																" id="subdistrict-list">
																	<!-- <?php foreach ($qe as $de) { ?>
																		<option value="<?php echo $de['id'] ?>"><?php echo $de['name'] ?></option>
																	<?php } ?> -->
																</select>
															</div>
														</div>
														<div class="row">
															...
															<div class="col-md-9 form-group">
																...
																<select name="village_location" class="col-12" style="border-color:#435ebe; color:#000000; padding: 8px 8px; border-radius: 4px;" id="village-list">
																	<!-- <?php foreach ($qde as $dd) { ?>
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="link_shrine" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
	...
	<script languange="javascript">
		...
		// 	$.ajax({
		// 		type: "POST",
		// 		url: "../../kamusControlller.php?action=getSubDistrict",
		// 		data: 'data',
		// 		success: function(data) {
		// 			$("#subdistrict-list").html(data);
		// 		}
