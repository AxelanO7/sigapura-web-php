						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Edit Data Shrines</li>
								</ol>
							</nav>
						</div>
					</div>
													...
													<div class="col-md-12">
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="name_object" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["name_object"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="description_detail" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["description_detail"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="description_visual" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["description_visual"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="period_of_creation" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["period_of_creation"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="name_creator" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["name_creator"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="creator_style" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["creator_style"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="main_material" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["main_material"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="additional_material" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["additional_material"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="creation_technique" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["creation_technique"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="ornament" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["ornament"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="physical_condition" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["physical_condition"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="level_of_damage" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["level_of_damage"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="country_location" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["country_location"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="district_location" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["district_location"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="subdistrict_location" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["subdistrict_location"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="village_location" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["village_location"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="functional" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["functional"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="ownership" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["ownership"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="ownership_history" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["ownership_history"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="historical_value" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["historical_value"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="cultural_value" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["cultural_value"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="aesthetic_value" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["aesthetic_value"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="economic_value" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["economic_value"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="link_shrine" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["link_shrine"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="file" name="image_shrine" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" />
																<!-- <input type="file" name="image_shrine" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" /> -->
															</div>
														</div>
														...
														<div class="row">
															<div class="col-md-3">
																<label style="color:#435ebe">Gambar Detail Pelinggih</label>
															</div>
															<div class="col-md-9 form-group">
																<input type="file" name="image_detail" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" />
																<!-- <input type="file" name="image_shrine" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" /> -->
															</div>
														</div>
