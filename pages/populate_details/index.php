                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Management Shrines</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <div class="alert alert-primary">Data Shrines</div>
                        </div>
                        <div class="card-body">
							<?php if($dz["ug_id"]!=1){ ?>
										...
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="row">
														<div class="col-md-3">
															<label style="color:#435ebe">Filter Shrines</label>
														</div>
                            ...
                            <div class="col-sm-12 d-flex justify-content-end">
                                <a href="formAdd.php" >
									<button type="button" class="btn btn-sm btn-primary pull-right">Add Shrines</button>
								</a>
                            </div>
                            <?php
                                if(isset($_GET['pesan'])){?>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $qu = mysqli_query($koneksi, "SELECT *,(SELECT name_object FROM shrines WHERE id=name_creator) as name FROM shrines ".$filter." ") or die(mysqli_errno($koneksi));
                                        while($du = mysqli_fetch_array($qu)){ ?>
                                        
                                            <tr>
                                                <td><?php echo $du["name_object"] ?></td>
                                                <td><?php echo $du["description_detail"] ?></td>
                                                <td><?php echo $du["year_of_creation"] ?></td>
                                                <td><?php echo $du["period_of_creation"] ?></td>
                                                <td><?php echo $du["main_material"] ?></td>
                                                <td>
