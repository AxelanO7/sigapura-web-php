				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							<h3>Input Data Province</h3>
							<p class="text-subtitle text-muted">Sigapura</p>
						</div>
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">Menu</a></li>
									<li class="breadcrumb-item active" aria-current="page">Input Data Province</li>
								</ol>
							</nav>
						</div>
					</div>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/areaController.php?action=addDataProvince" method="POST">
											<?php $timestart = time(); ?>
											...
											<div class="form-body">
												...
												<div class="row" style="margin-top:16px;">
													<div class="alert alert-danger">Input Data Province</div>
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-3">
