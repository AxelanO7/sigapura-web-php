...
$qt = mysqli_query($koneksi, "SELECT * FROM province WHERE id='" . $_GET["id"] . "' ");
						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Edit Data Province</li>
								</ol>
							</nav>
						</div>
					</div>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/areaController.php?action=editDataProvince" method="POST">
											<?php $timestart = time(); ?>
											...
											<div class="form-body">
												<div class="row" style="margin-top:40px;">
													<div class="alert alert-danger">Input Data Provinsi</div>
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-3">
					...
					<div class="col-12 col-lg-3">
						...
						<div class="card">
							...
							<div class="card-content pb-4">
								...
								$qu = mysqli_query($koneksi, "SELECT name FROM province") or die(mysqli_errno($koneksi));
								while ($du = mysqli_fetch_array($qu)) { ?>
									<div class="recent-message d-flex px-4 py-3">
										...
										<div class="name ms-4">
											...
											<h6 class="text-muted mb-0">Indonesia</h6>
										</div>
									</div>
								<?php
								}
								?>
								<div class="px-4">
									<a href="index.php"><button class='btn btn-block btn-xl btn-light-primary font-bold mt-3'>View Province</button></a>
								</div>
							</div>
						</div>
					</div>
