...
<body>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Management Province</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <div class="alert alert-primary">Data Province</div>
                        </div>
                        <div class="card-body">
                            <?php if ($dz["ug_id"] != 1) { ?>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label style="color:#435ebe">Filter Province</label>
                                                    </div>
                            ...
                            <div class="col-sm-12 d-flex justify-content-end">
                                <a href="formAdd.php">
                                    <button type="button" class="btn btn-sm btn-primary pull-right">Add Province</button>
                                </a>
                            </div>
                            <?php
                            if (isset($_GET['pesan'])) { ?>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    // $qu = mysqli_query($koneksi, "SELECT *,(SELECT nama FROM province WHERE id=name_creator) as name FROM province ".$filter." ") or die(mysqli_errno($koneksi));
                                    $qu = mysqli_query($koneksi, "SELECT * FROM province");
                                    $no = 1;
    ...
    <script languange="javascript">
        function viewFormDelete(id) {
            ...
            $('#form').attr('action', "../../apps/areaController.php?action=deleteDataProvince&id=" + id);
            $('#modal').modal('show');
        }
    </script>
    </div>
