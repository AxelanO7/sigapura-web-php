                            ...
                            <div class="card">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 text-center" >
                                        <img src="../../skins/mazer/demo/assets/images/logo/logo-kamus.png" style="height:70px; margin-bottom:10px;margin-top:50px;" alt="Logo" srcset="">
                                    </div>
                                </div>
                                <div class="card-header" style="padding: 1.5rem 1.5rem 0 1.5rem;">
                                    <h4 class="card-title text-center">Input Kata yang akan di cari!</h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8" >
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" style="border-color:#435ebe; color :#435ebe; " id="basic-addon1"><i class="bi bi-search"></i></span>
                                                        <input type="text" style="border-color:#435ebe; color:#000000;" name="keyword" class="form-control" placeholder="Kata Kunci......"  aria-describedby="button-addon2">
