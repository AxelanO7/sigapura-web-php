						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Input Data Kecamatan</li>
								</ol>
							</nav>
						</div>
					</div>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/areaController.php?action=addDataSubDistrict" method="POST">
											<?php $timestart = time(); ?>
											...
											<div class="form-body">
												...
												<div class="row" style="margin-top:16px;">
													...
													<div class="col-md-12">
														...
														<div class="row">
															<div class="col-md-3">
																<label style="color:#435ebe">Lokasi Kota / Kabupaten</label>
															</div>
															<div class="col-md-9 form-group">
