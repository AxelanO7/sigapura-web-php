							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/areaController.php?action=editDataSubDistrict" method="POST">
											<?php $timestart = time(); ?>
											...
											<div class="form-body">
												<div class="row" style="margin-top:40px;">
													<div class="alert alert-danger">Input Data Kecamatan</div>
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-3">
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<select name="id_district" class="col-12" style="border-color:#435ebe; color:#000000; padding: 8px 8px; border-radius: 4px;">
																	<?php
