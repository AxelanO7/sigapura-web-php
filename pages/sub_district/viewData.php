...
$qt = mysqli_query($koneksi, "SELECT * FROM sub_district WHERE id='" . $_GET["id"] . "' ");
						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">View Data Kecamatan</li>
								</ol>
							</nav>
						</div>
					</div>
													...
													<div class="col-md-12">
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="name" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["name"] ?>" disabled />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
																<label style="color:#435ebe">Kota / Kabupaten</label>
															</div>
															<div class="col-md-9 form-group">
																<input type="text" name="country_region" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php
																																																	$qu2 = mysqli_query($koneksi, "SELECT name FROM district WHERE id='" . $dt["id_district"] . "'") or die(mysqli_errno($koneksi));
					...
					<div class="col-12 col-lg-3">
						...
						<div class="card">
							...
							<div class="card-content pb-4">
								...
								$qu = mysqli_query($koneksi, "SELECT * FROM sub_district LIMIT 0,10") or die(mysqli_errno($koneksi));
									...
									<div class="recent-message d-flex px-4 py-3">
										...
										<div class="name ms-4">
											...
											<h6 class="text-muted mb-0">
												<?php
												$qu2 = mysqli_query($koneksi, "SELECT name FROM district WHERE id='" . $du["id_district"] . "'") or die(mysqli_errno($koneksi));
												$du2 = mysqli_fetch_array($qu2);
												echo $du2["name"];
												?>
											</h6>
								...
								?>
								<div class="px-4">
									<a href="index.php"><button class='btn btn-block btn-xl btn-light-primary font-bold mt-3'>View Kecamatan</button></a>
								</div>
							</div>
						</div>
					</div>
