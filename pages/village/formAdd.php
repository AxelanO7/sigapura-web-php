...
<body>
						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Input Data Kelurahan</li>
								</ol>
							</nav>
						</div>
					</div>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/areaController.php?action=addDataVillage" method="POST">
											<?php $timestart = time(); ?>
												...
												<div class="row" style="margin-top:16px;">
													...
													<div class="col-md-12">
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<select class="form-select" name="id_sub_district" style="border-color:#435ebe; color:#000000;" aria-label="Default select example">
																	<option value=""></option>
																	<?php
																	$q = mysqli_query($koneksi, "SELECT * FROM sub_district ORDER BY name");
	...
	$qsw = mysqli_query($koneksi, "SELECT * FROM village ORDER BY name");
