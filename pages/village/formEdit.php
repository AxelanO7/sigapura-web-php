...
$qs = mysqli_query($koneksi, "SELECT * FROM sub_district");
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/areaController.php?action=editDataVillage" method="POST">
											<?php $timestart = time(); ?>
											...
											<div class="form-body">
												<div class="row" style="margin-top:40px;">
													<div class="alert alert-danger">Input Data Kelurahan</div>
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-3">
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<select type="text" name="id_sub_district" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;">
																	<?php
