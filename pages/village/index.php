...
<body>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Management Kelurahan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <div class="alert alert-primary">Data Kelurahan</div>
                        </div>
                        <div class="card-body">
                            <?php if ($dz["ug_id"] != 1) { ?>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label style="color:#435ebe">Filter Kelurahan</label>
                                                    </div>
                            ...
                            <div class="col-sm-12 d-flex justify-content-end">
                                <a href="formAdd.php">
                                    <button type="button" class="btn btn-sm btn-primary pull-right">Add Kelurahan</button>
                                </a>
                            </div>
                            <?php
                            if (isset($_GET['pesan'])) { ?>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    // $qu = mysqli_query($koneksi, "SELECT *,(SELECT nama FROM Kelurahan WHERE id=name_creator) as name FROM Kelurahan ".$filter." ") or die(mysqli_errno($koneksi));
                                    $qu = mysqli_query($koneksi, "SELECT * FROM village");
                                    while ($du = mysqli_fetch_array($qu)) { ?>
                                        <tr>
                                            <td><?php echo $du["name"] ?></td>
                                            <td>
                                                <?php
                                                $qu2 = mysqli_query($koneksi, "SELECT * FROM sub_district WHERE id='" . $du["id_sub_district"] . "'") or die(mysqli_errno($koneksi));
    ...
    <script languange="javascript">
        function viewFormDelete(id) {
            ...
            $('#form').attr('action', "../../apps/areaController.php?action=deleteDataVillage&id=" + id);
            $('#modal').modal('show');
        }
    </script>
    </div>
