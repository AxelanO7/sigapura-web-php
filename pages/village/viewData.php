...
$qt = mysqli_query($koneksi, "SELECT * FROM village WHERE id='" . $_GET["id"] . "' ");
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">View Data Kelurahan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <form class="form form-horizontal" action="../../apps/kamusController.php?action=editData" method="POST">
                                            ...
                                            <div class="form-body">
                                                <div class="row" style="margin-top:40px;">
                                                    <div class="alert alert-danger">Lihat Data Kelurahan</div>
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <label style="color:#435ebe">Kecamatan</label>
                                                            </div>
                                                            <div class="col-md-9 form-group">
                                                                <input type="text" name="name" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php
                                                                                                                                                                                        $qu2 = mysqli_query($koneksi, "SELECT name FROM sub_district WHERE id='" . $dt["id_sub_district"] . "' ") or die(mysqli_errno($koneksi));
                    ...
                    <div class="col-12 col-lg-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content pb-4">
                                ...
                                $qu = mysqli_query($koneksi, "SELECT * FROM village LIMIT 0,10 ") or die(mysqli_errno($koneksi));
                                    ...
                                    <div class="recent-message d-flex px-4 py-3">
                                        ...
                                        <div class="name ms-4">
                                            ...
                                            <h6 class="text-muted mb-0">
                                                <?php
                                                $qu2 = mysqli_query($koneksi, "SELECT name FROM sub_district WHERE id='" . $du["id_sub_district"] . "' ") or die(mysqli_errno($koneksi));
                                                $du2 = mysqli_fetch_array($qu2);
                                                echo $du2["name"];
                                                ?>
                                            </h6>
                                ...
                                ?>
                                <div class="px-4">
                                    <a href="index.php"><button class='btn btn-block btn-xl btn-light-primary font-bold mt-3'>View Kelurahan</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
