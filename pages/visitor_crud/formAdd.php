						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Input Data Visitor</li>
								</ol>
							</nav>
						</div>
					</div>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/visitorController.php?action=addData" method="POST">
											<?php $timestart = time(); ?>
											...
											<div class="form-body">
												...
												<div class="row" style="margin-top:16px;">
													<div class="alert alert-danger">Input Data Visitor</div>
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-3">
														...
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="country_region" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="gender" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" />
															</div>
														</div>
														<div class="col-md-12">
															<div class="row">
