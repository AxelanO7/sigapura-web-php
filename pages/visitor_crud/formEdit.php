...
$qt = mysqli_query($koneksi, "SELECT * FROM visitor WHERE id='" . $_GET["id"] . "' ");
						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Edit Data Visitor</li>
								</ol>
							</nav>
						</div>
					</div>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										...
										<?php } ?>
										<form class="form form-horizontal" action="../../apps/visitorController.php?action=editData" method="POST">
											<?php $timestart = time(); ?>
													...
													<div class="col-md-12">
														<div class="row">
															...
															<div class="col-md-9 form-group">
																<input type="text" name="name" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["name"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
																<label style="color:#435ebe">Asal Negara</label>
															</div>
															<div class="col-md-9 form-group">
																<input type="text" name="country_region" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["country_region"] ?>" />
															</div>
														</div>
														<div class="row">
															<div class="col-md-3">
																<label style="color:#435ebe">Jenis Kelamin</label>
															</div>
															<div class="col-md-9 form-group">
																<input type="text" name="description_visual" class="form-control" placeholder="" style="border-color:#435ebe; color:#000000;" value="<?php echo $dt["gender"] ?>" />
															</div>
														</div>
														<div class="col-md-12">
															<div class="row">
					...
					<div class="col-12 col-lg-3">
						...
						<div class="card">
							...
							<div class="card-content pb-4">
								...
								$qu = mysqli_query($koneksi, "SELECT *,(SELECT name FROM users WHERE id=name) AS name FROM visitor ORDER BY created_at DESC LIMIT 0,10 ") or die(mysqli_errno($koneksi));
								while ($du = mysqli_fetch_array($qu)) { ?>
									<div class="recent-message d-flex px-4 py-3">
										...
										<div class="name ms-4">
											...
											<h6 class="text-muted mb-0">from <?php echo $du["country_region"] ?></h6>
										</div>
									</div>
								<?php
								}
								?>
								<div class="px-4">
									<a href="index.php"><button class='btn btn-block btn-xl btn-light-primary font-bold mt-3'>View Visitor</button></a>
								</div>
							</div>
						</div>
					</div>
