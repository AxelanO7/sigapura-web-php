...
<body>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Management Visitor</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label style="color:#435ebe">Filter Visitor</label>
                                                    </div>
                            ...
                            <div class="col-sm-12 d-flex justify-content-end">
                                <a href="formAdd.php">
                                    <button type="button" class="btn btn-sm btn-primary pull-right">Add Visitor</button>
                                </a>
                            </div>
                            <?php
                            if (isset($_GET['pesan'])) { ?>
                                ...
                                <tbody>
                                    ...
                                    while ($du = mysqli_fetch_array($qu)) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $du["country_region"] ?></td>
                                            <td><?php echo $du["gender"] ?></td>
                                            <td>
    ...
    <script languange="javascript">
        function viewFormDelete(id) {
            ...
            $('#form').attr('action', "../../apps/visitorController.php?action=deleteData&id=" + id);
            $('#modal').modal('show');
        }
    </script>
    </div>
